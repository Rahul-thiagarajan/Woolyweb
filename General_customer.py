...
def complete_general(a):
    if(request.method=="POST"):
        ...
        a=json.loads(a)
        r_general.clear()
        obj6=pymysql.connect(host="localhost",user="root",password="2theeran7",database="woolyweb")
        cur6=obj6.cursor()
        cur7=obj6.cursor()
        ...
        objz=pymysql.connect(host="localhost",user="root",password="2theeran7",database="aadhar")
        curz=objz.cursor()
